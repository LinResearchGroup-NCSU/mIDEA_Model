...
#cp for_training_gamma/gammas/randomized_decoy/native_trainSetFiles_phi_pairwise_contact_well-1.0_9.5_5.0_10_gamma_filtered for_bindingE/loocv/gammas/randomized_decoy/native_trainSetFiles_phi_pairwise_contact_well-1.0_9.5_5.0_10_gamma_filtered
# Copy the trained gamma file from the multi-protein cases;
#cp ../../max_proteins_new/optimization/for_training_gamma/gammas/randomized_decoy/native_trainSetFiles_phi_pairwise_contact_well-8.0_8.0_0.7_10_gamma_filtered for_bindingE/loocv/gammas/randomized_decoy/native_trainSetFiles_phi_pairwise_contact_well-8.0_8.0_0.7_10_gamma_filtered
